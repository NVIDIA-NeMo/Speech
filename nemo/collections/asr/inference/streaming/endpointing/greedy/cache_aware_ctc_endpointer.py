...
class CacheAwareCTCEndpointer(CacheAwareEndpointer):
    """Cache-aware endpointing for the streaming CTC pipeline (CTC token semantics)."""
    ...
    def __init__(
        ...
        """
        super().__init__(
            TokenClassifier.for_ctc(vocabulary, absorb_token_ids),
            ms_per_timestep,
