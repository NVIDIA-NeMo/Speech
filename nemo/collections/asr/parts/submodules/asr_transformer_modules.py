...
class ASRTransformerLayer(torch.nn.Module, AttentionAdapterModuleMixin, AccessMixin):
    """A single block of the ASR Transformer encoder.
    ...
    Args:
        ...
        use_bias (bool): Apply bias to all Linear layers from each ASRTransformerLayer to improve activation flow and stabilize training of huge models.
            Defaults to True.
    """
