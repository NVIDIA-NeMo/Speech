...
def test_checkpoint_unfinished_check():
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        assert not ModelCheckpoint.is_checkpoint_unfinished(checkpoint_path), \
        ...
        assert ModelCheckpoint.is_checkpoint_unfinished(checkpoint_path), \
            "Checkpoint should be marked as unfinished"
