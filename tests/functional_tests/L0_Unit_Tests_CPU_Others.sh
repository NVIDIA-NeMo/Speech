...
CUDA_VISIBLE_DEVICES="" NEMO_NUMBA_MINVER=0.53 pytest --cov=/workspace --cov-report= -n auto --dist=loadfile -m "not pleasefixme" --cpu --with_downloads --relax_numba_compat \
