...
apt update && apt install -y gdb && gdb -ex "set confirm off" -ex "set pagination off" -ex r -ex bt -ex q --args  coverage run -a --data-file=/workspace/.coverage --source=/workspace/nemo scripts/magpietts/infer_and_evaluate.py \
